document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateDataValues(currentLoad, demand, supplyCapacity) {
            document.querySelector('.data-card:nth-child(1) .data-value').textContent = currentLoad + ' MW';
            document.querySelector('.data-card:nth-child(2) .data-value').textContent = demand + ' MW';
            document.querySelector('.data-card:nth-child(3) .data-value').textContent = supplyCapacity + ' MW';
        }
